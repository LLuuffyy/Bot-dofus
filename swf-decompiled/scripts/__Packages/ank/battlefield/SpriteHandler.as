class ank.battlefield.SpriteHandler
{
   ...
   function clear(bKeepData)
   {
      ...
      {
         this.removeSprite(_loc4_,bKeepData);
      }
   }
   function getSprites()
   {
   ...
   function removeEffectsByCasterID(sCasterID)
   {
      ...
      for(var _loc4_ in _loc3_)
      {
         ...
         _loc6_ = _loc5_.EffectsManager;
         if(_loc6_ != undefined)
         {
            _loc6_.removeEffectsByCasterID(sCasterID);
         }
      }
   }
   ...
   function removeSprite(sID, bKeepData)
   {
      ...
      if(_loc4_.hasChilds)
      {
         ...
         {
            this.removeSprite(_loc5_[_loc6_].id,bKeepData);
         }
      }
      ...
      {
         _loc7_ = _loc4_.carriedParent;
         _loc4_.carriedParent.carriedChild = undefined;
         _loc7_.mc.setAnim("static",false,false);
      }
   ...
   function hideSprite(sID, bHide)
   {
      ...
      if(_loc4_.hasChilds)
      {
         ...
         for(var _loc6_ in _loc5_)
         {
            this.hideSprite(_loc5_[_loc6_].id,bHide);
         }
      }
   ...
   function hideSprites(bHide, nType)
   {
      ...
      var _loc4_ = this.getSprites().getItems();
      var _loc6_;
      var _loc7_;
      var _loc8_;
      var _loc9_;
      ...
      for(var _loc5_ in _loc4_)
      {
         if(_loc5_ != this.api.datacenter.Player.ID)
         {
            ...
            {
               case 1:
                  _loc9_ = _loc8_ instanceof dofus.datacenter.Character || (_loc8_ instanceof dofus.datacenter.MonsterGroup || (_loc8_ instanceof dofus.datacenter.OfflineCharacter || _loc8_ instanceof dofus.datacenter.PrismSprite));
                  break;
               case 2:
                  _loc9_ = _loc8_ instanceof dofus.datacenter.NonPlayableCharacter;
                  break;
               case 3:
                  _loc9_ = _loc8_ instanceof dofus.datacenter.MonsterGroup;
                  break;
               case 4:
                  _loc9_ = _loc8_ instanceof dofus.datacenter.Character;
               default:
                  _loc9_ = true;
            }
            if(_loc9_)
            {
               ...
               _loc10_ = _loc6_.linkedChilds.getItems();
               for(var _loc11_ in _loc10_)
               {
                  _loc12_ = _loc10_[_loc11_];
                  _loc12_.mc.setVisible(!bHide);
               }
            }
         }
      }
   ...
   function setSpriteDirection(sID, nDir)
   {
      ...
      if(_loc4_.hasChilds)
      {
         ...
         for(var _loc6_ in _loc5_)
         {
            this.setSpriteDirection(_loc5_[_loc6_].id,nDir);
         }
      }
      if(_loc4_.hasCarriedChild())
      {
      ...
      var _loc7_ = _loc4_.mc;
      _loc7_.setDirection(nDir);
   }
   function setSpritePosition(sID, nCellNum, nDir)
   {
      ...
      if(_loc6_.hasChilds)
      {
         _loc7_ = _loc6_.linkedChilds.getItems();
         for(var _loc8_ in _loc7_)
         {
            _loc9_ = ank.battlefield.utils.Pathfinding.getArroundCellNum(this._mcBattlefield.mapHandler,nCellNum,nDir,_loc7_[_loc8_].childIndex);
            this.setSpriteDirection(_loc7_[_loc8_].id,_loc9_,nDir);
         }
      }
      this._mcBattlefield.removeSpriteBubble(sID);
      if(nDir != undefined)
      {
         _loc6_.direction = nDir;
      }
      var _loc10_ = _loc6_.mc;
      _loc10_.setPosition(nCellNum);
   }
   ...
   function moveSprite(sID, path, seq, bClearSequencer, sAnimation, bForcedRun, bForcedWalk, runLimit)
   {
      ...
      if(_loc12_.hasChilds)
      {
         ...
         for(var _loc16_ in _loc15_)
         {
            _loc17_ = _loc15_[_loc16_];
            _loc18_ = ank.battlefield.utils.Pathfinding.getArroundCellNum(this._mcBattlefield.mapHandler,_loc13_,_loc14_,_loc17_.childIndex);
            _loc19_ = ank.battlefield.utils.Pathfinding.pathFind(this.api,this._mcBattlefield.mapHandler,_loc17_.cellNum,_loc18_,{bAllDirections:_loc17_.allDirections,bIgnoreSprites:true,bCellNumOnly:true,bWithBeginCellNum:true});
            if(_loc19_ != null)
            {
               ank.utils.Timer.setTimer(_loc17_,"battlefield",this,this.moveSprite,200 + (_loc12_.cellNum != _loc17_.cellNum ? 0 : 200),[_loc17_.id,_loc19_,_loc17_.sequencer,bClearSequencer,sAnimation,_loc17_.forceRun || bForcedRun,_loc17_.forceWalk || bForcedWalk,runLimit]);
            }
         }
      }
      var _loc20_ = _loc12_.mc;
      if(bClearSequencer)
      {
         if(!_loc10_)
         {
      ...
      seq.addAction(10,false,_loc20_,_loc20_.setPosition,[path[0]]);
      var _loc21_ = path.length;
      var _loc22_ = _loc21_ - 1;
      var _loc23_ = 0;
      var _loc24_;
      var _loc25_;
      var _loc26_;
      ...
      while(_loc23_ < _loc21_)
      {
         ...
         if(_loc23_ != 0)
         {
            _loc27_ = this._mcBattlefield.mapHandler.getCellHeight(path[_loc23_ - 1]);
            _loc28_ = this._mcBattlefield.mapHandler.getCellHeight(path[_loc23_]);
            if(Math.abs(_loc27_ - _loc28_) > 0.5 && this._mcBattlefield.isJumpActivate)
            {
               _loc24_ = "jump";
               _loc25_ = "run";
               _loc26_ = true;
         ...
         seq.addAction(11,true,_loc20_,_loc20_.moveToCell,[seq,path[_loc23_],_loc23_ == _loc22_,_loc25_,_loc24_,_loc26_]);
         _loc23_ += 1;
      }
      seq.execute();
   }
   function setCreatureMode(bEnabled)
   {
      ...
      {
         _loc5_ = _loc3_[_loc4_];
         if(_loc5_ instanceof dofus.datacenter.Character)
         {
            if(_loc5_.canSwitchInCreaturesMode)
            {
               if(!(_loc5_ instanceof dofus.datacenter.Mutant))
               {
                  if(bEnabled)
                  {
                     if(!_loc5_.bInCreaturesMode)
                     {
                        _loc5_.tmpGfxFile = _loc5_.gfxFile;
                        _loc5_.tmpMount = _loc5_.mount;
                        _loc5_.mount = undefined;
                        _loc6_ = dofus.Constants.CLIPS_PERSOS_PATH + _loc5_.Guild + "2.swf";
                        this.api.gfx.setSpriteGfx(_loc5_.id,_loc6_);
                        _loc5_.bInCreaturesMode = true;
                     }
                  }
                  else if(_loc5_.bInCreaturesMode)
                  {
                     _loc5_.mount = _loc5_.tmpMount;
                     delete _loc5_.tmpMount;
                     _loc7_ = _loc5_.tmpGfxFile != undefined ? _loc5_.tmpGfxFile : _loc5_.gfxFile;
                     delete _loc5_.tmpGfxFile;
                     this.api.gfx.setSpriteGfx(_loc5_.id,_loc7_);
                     _loc5_.bInCreaturesMode = false;
                  }
               }
            }
         }
   ...
   function showMonstersTooltip(bShow)
   {
      ...
      for(var _loc4_ in _loc3_)
      {
         _loc5_ = _loc3_[_loc4_].mc;
         _loc6_ = _loc5_.data;
         if(_loc6_ instanceof dofus.datacenter.MonsterGroup)
         {
            if(bShow)
            {
               _loc5_._rollOver(true);
            }
            else
            {
               _loc5_._rollOut(true);
            }
         }
      }
   }
   ...
   function setSpriteGhostView(bool)
   {
      ...
      for(var _loc4_ in _loc3_)
      {
         _loc5_ = this._oSprites.getItemAt(_loc4_);
         _loc5_.mc.setGhostView(_loc5_.allowGhostMode && bool);
      }
   }
   function selectSprite(sID, bSelect)
   {
      ...
      if(_loc4_.hasChilds)
      {
         ...
         for(var _loc6_ in _loc5_)
         {
            this.selectSprite(_loc5_[_loc6_].id,bSelect);
         }
      }
