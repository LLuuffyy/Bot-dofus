class dofus.managers.KeyManager extends dofus.utils.ApiElement
{
   ...
   function loadShortcuts()
   {
      ...
      if(_loc3_ != undefined)
      {
         _loc4_ = new ank.utils.ExtendedString(_loc3_).replace("#","_") + "_" + dofus.Constants.GLOBAL_SO_SHORTCUTS_NAME;
         this._so = SharedObject.getLocal(_loc4_);
      }
      if(this._nCurrentSet == undefined)
      {
         this._nCurrentSet = this.api.kernel.OptionsManager.getOption("ShortcutSet");
      }
      var _loc5_ = this.api.lang.getKeyboardShortcuts();
      this._aNoChatShortcuts = [];
      this._aAnyTimeShortcuts = [];
      var _loc6_;
      var _loc7_;
      ...
      {
         _loc6_ = this.api.lang.getKeyboardShortcutsKeys(this._nCurrentSet,_loc9_);
         _loc7_ = this.getCustomShortcut(_loc9_,false);
         if(_loc7_ != undefined && !_loc5_[_loc9_].s)
         {
            if(_loc6_.o)
            {
               this._aNoChatShortcuts.push({k:_loc7_.k,c:_loc7_.c,o:_loc6_.o,d:_loc9_,l:_loc7_.i,s:_loc5_[_loc9_].s});
            }
            else
            {
               this._aAnyTimeShortcuts.push({k:_loc7_.k,c:_loc7_.c,o:_loc6_.o,d:_loc9_,l:_loc7_.i,s:_loc5_[_loc9_].s});
            }
         }
         else if(_loc6_.o)
         {
            this._aNoChatShortcuts.push({k:_loc6_.k,c:_loc6_.c,o:_loc6_.o,d:_loc9_,l:_loc6_.s,s:_loc5_[_loc9_].s});
         }
         else if(_loc6_.k != undefined)
         {
            this._aAnyTimeShortcuts.push({k:_loc6_.k,c:_loc6_.c,o:_loc6_.o,d:_loc9_,l:_loc6_.s,s:_loc5_[_loc9_].s});
         }
         _loc8_ = this.getCustomShortcut(_loc9_,true);
         if(_loc8_ != undefined && !_loc5_[_loc9_].s)
         {
            if(_loc6_.o)
            {
               this._aNoChatShortcuts.push({k:_loc8_.k,c:_loc8_.c,o:_loc6_.o,d:_loc9_,l:_loc8_.i,s:_loc5_[_loc9_].s});
            }
            else
            {
               this._aAnyTimeShortcuts.push({k:_loc8_.k,c:_loc8_.c,o:_loc6_.o,d:_loc9_,l:_loc8_.i,s:_loc5_[_loc9_].s});
            }
         }
         else if(!_global.isNaN(_loc6_.k2) && _loc6_.k2 != undefined)
         {
            if(_loc6_.o)
            {
               this._aNoChatShortcuts.push({k:_loc6_.k2,c:_loc6_.c2,o:_loc6_.o,d:_loc9_,l:_loc6_.s2,s:_loc5_[_loc9_].s});
            }
            else
            {
               this._aAnyTimeShortcuts.push({k:_loc6_.k2,c:_loc6_.c2,o:_loc6_.o,d:_loc9_,l:_loc6_.s2,s:_loc5_[_loc9_].s});
            }
         }
      }
      var _loc10_;
      ...
      if(this._aNoChatShortcuts.length == 0 && this._aAnyTimeShortcuts.length == 0)
      {
         ...
         _loc10_ = this.api.lang.getDefaultConsoleShortcuts();
         _loc11_ = 0;
         while(_loc11_ < _loc10_.length)
         {
            this._aAnyTimeShortcuts.push({k:_loc10_[_loc11_].k,c:1,o:true,d:"CONSOLE"});
            _loc11_ += 1;
         }
         _loc12_ = 0;
         while(_loc12_ < _loc10_.length)
         {
            this._aAnyTimeShortcuts.push({k:_loc10_[_loc12_].k,c:2,o:true,d:"CONSOLESIZE"});
            _loc12_ += 1;
         }
      }
   }
   ...
   function isKeyPressed(nKeyCode)
   {
      return this._bPressedKeys[nKeyCode] == true;
   }
   function onShortcut(sShortcut)
   {
      ...
      switch(sShortcut)
      {
         ...
         case "MOUNTING":
            ...
            break;
         case "FULLSCREEN":
            this.api.kernel.GameManager.isFullScreen = _loc5_ = !this.api.kernel.GameManager.isFullScreen;
            fscommand("fullscreen",_loc5_);
            _loc3_ = false;
            break;
         case "ALLOWSCALE":
            this.api.kernel.GameManager.isAllowingScale = _loc5_ = !this.api.kernel.GameManager.isAllowingScale;
            fscommand("allowscale",_loc5_);
            _loc3_ = false;
      }
      return _loc3_;
   }
