class dofus.managers.GameManager extends dofus.utils.ApiElement
{
   ...
   function terminateFight()
   {
      ...
      if(!this.api.datacenter.Game.isSpectator)
      {
         ...
         if(!this.api.datacenter.Player.isSkippingLootPanel && !this.api.kernel.OptionsManager.getOption("DisableGameResult"))
         {
   ...
   function showEndPanel(nID, bInputIsIndex)
   {
      ...
      var _loc5_ = nID == -1 || nID == undefined;
      var _loc6_;
      if(!bInputIsIndex)
      {
         if(!_loc5_)
         {
            _loc6_ = _loc4_.findFirstItem("id",nID).index;
            if(_loc6_ == -1)
            {
      ...
      {
         this.api.ui.loadUIComponent("GameResultLight","GameResultLight",{data:(!_loc5_ ? _loc4_[_loc6_] : this.api.datacenter.Game.results)},{bAlwaysOnTop:true});
      }
      else
      {
         this.api.ui.loadUIComponent("GameResult","GameResult",{data:(!_loc5_ ? _loc4_[_loc6_] : this.api.datacenter.Game.results)},{bAlwaysOnTop:true});
      }
   }
   ...
   function switchToSpellLaunch(oSpell, bSpell, bForced)
   {
      ...
      this.api.gfx.clearPointer();
      var _loc5_ = this.api.datacenter.Game.isControllingInvocation ? this.api.datacenter.Game.controlledInvocationCell : this.api.datacenter.Player.data.cellNum;
      var _loc6_;
      var _loc7_;
      var _loc8_;
      ...
      var _loc9_ = oSpell.getFilteredEffectZones != undefined ? oSpell.getFilteredEffectZones() : oSpell.effectZones;
      var _loc10_ = 0;
   ...
   function drawAllowedZone(lineOnly, originCell, innerRay, outerRay, bAnimate)
   {
      ...
      var _loc12_;
      var _loc13_;
      for(; _loc11_ < _loc7_.length; _loc11_ += 1)
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(nSpell > 0)
            {
               ...
               else if(this.api.kernel.SpellsBoostsManager.isBoostedDamagingEffect(_loc8_))
               {
                  ...
                  _loc11_ = this.api.kernel.SpellsBoostsManager.getSpellModificator(dofus.managers.SpellsBoostsManager.ACTION_BOOST_SPELL_ADD_BASE_DAMAGE,nSpell);
                  if(_loc11_ > 0)
                  {
                     _loc9_ = _loc9_ > 0 ? _loc9_ + _loc11_ : _loc11_;
                  }
               }
            }
   ...
   function updateCompass(nX, nY, bForced)
   {
      ...
      if(!bForced && (this.api.datacenter.Basics.banner_targetCoords[0] == nX && this.api.datacenter.Basics.banner_targetCoords[1] == nY) || (_global.isNaN(nX) || _global.isNaN(nY)))
      {
         ...
         if(_loc6_.illustrationType != "map")
         {
            _loc6_.circleXtra.showCircleXtra("artwork",true,{bMask:true});
         }
         return false;
      }
      var _loc7_ = this.api.datacenter.Map;
      if(_loc6_.illustrationType != "map")
      {
         _loc6_.circleXtra.showCircleXtra("compass",true,{bMask:true},{updateOnLoad:false});
      }
      _loc6_.circleXtra.setCircleXtraParams({allCoords:{targetCoords:[nX,nY],currentCoords:[_loc7_.x,_loc7_.y]}});
   ...
   function mergeTwoInventory(a1, a2)
   {
      ...
      var _loc4_ = 0;
      while(_loc4_ < a1.length)
      {
         _loc3_.push(a1[_loc4_]);
         _loc4_ += 1;
      }
      var _loc5_ = 0;
      while(_loc5_ < a2.length)
      {
         _loc3_.push(a2[_loc5_]);
         _loc5_ += 1;
      }
      return _loc3_;
   }
   function mergeUnicItemInInventory(inventory)
   {
      ...
      var _loc4_ = 0;
      var _loc5_;
      while(_loc4_ < inventory.length)
      {
         _loc5_ = inventory[_loc4_];
         if(_loc3_[_loc5_.unicID] == undefined)
         {
            _loc3_[_loc5_.unicID] = _loc5_.clone();
         }
         else
         {
            _loc3_[_loc5_.unicID].Quantity += _loc5_.Quantity;
         }
         _loc4_ += 1;
      }
   ...
   {
      var _loc4_ = oSpriteData;
      if(_loc4_ == null)
      {
         return undefined;
      }
      var _loc5_ = this.api.datacenter.Game.isFight;
      var _loc6_ = _loc4_.id;
      var _loc7_ = _loc4_.name;
      var _loc8_ = this.api.ui.createPopupMenu();
      _loc8_.addStaticItem(_loc7_);
      if(_loc5_ && (!this.api.datacenter.Game.isRunning && (_loc4_.kickable || this.api.datacenter.Player.isAuthorized)))
      {
         _loc8_.addItem(this.api.lang.getText("KICK"),this.api.network.Game,this.api.network.Game.leave,[_loc6_]);
      }
      if(_loc8_.items.length > 1)
      {
   ...
   function showCellPlayersPopupMenu(allSpritesOnCell)
   {
      ...
      var _loc6_;
      var _loc7_;
      for(var _loc8_ in allSpritesOnCell)
      {
         _loc6_ = this.api.gfx.getSprite(_loc8_);
         if(_loc6_ instanceof dofus.datacenter.Character || _loc6_ instanceof dofus.datacenter.Mutant && _loc6_.showIsPlayer)
         {
            if(_loc6_.gfxID != ank.battlefield.datacenter.Sprite.ANGELS_OF_THE_WORLD_SPRITE_ID)
            {
               _loc4_ = true;
               _loc7_ = _loc6_.name + " >>";
               _loc5_.addItem(_loc7_,this,this.showPlayerPopupMenu,[_loc6_]);
            }
         }
      }
      if(_loc4_)
   ...
   function showMessagePopupMenu(sPlayerID, sPlayerName, sMessage, oCustomPopupPosition)
   {
      ...
      _loc7_.addItem(sPlayerName + " >>",this.api.kernel.GameManager,this.api.kernel.GameManager.showPlayerPopupMenu,[undefined,{sPlayerID:sPlayerID,sPlayerName:sPlayerName,bShowJoinFriend:this.api.datacenter.Player.isAuthorized,bKeepSavedMessage:true}],true);
      _loc7_.addItem(this.api.lang.getText("COPY"),System,System.setClipboard,[new ank.utils.ExtendedString(sMessage).xmlUnescape()],true);
      if(this.api.datacenter.Player.isAuthorized)
      {
         _loc7_.addItem("Append To Current ModReport Description",dofus.graphics.gapi.ui.MakeReport,dofus.graphics.gapi.ui.MakeReport.updateDescription,[this.api,sMessage],true);
      }
      if(oCustomPopupPosition != undefined)
      {
         _loc7_.show(oCustomPopupPosition.x,oCustomPopupPosition.y,true);
      }
      else
      {
   ...
   {
      var _loc5_ = oParams.bKeepSavedMessage;
      var _loc6_ = oParams.bForceNonAdminPopup;
      var _loc7_ = oParams.sPlayerName;
      var _loc8_ = oParams.oCustomPopupPosition;
      if(!_loc5_)
      {
      ...
      else
      {
         ...
         _loc10_ = this.api.datacenter.Sprites.getItems();
         for(var _loc12_ in _loc10_)
         {
            _loc11_ = _loc10_[_loc12_];
            if(_loc11_.name.toUpperCase() == _loc7_.toUpperCase())
            {
               _loc9_ = _loc11_;
            }
         }
      ...
      var _loc14_ = _loc7_ != undefined ? _loc7_ : _loc9_.name;
      var _loc15_;
      var _loc16_;
      var _loc17_;
      if(Key.isDown(Key.SHIFT) && _loc14_ != this.api.datacenter.Player.Name)
      {
         _loc15_ = "/w " + _loc14_ + " ";
         _loc16_ = this.api.ui.getUIComponent("Banner");
         _loc16_.txtConsole = _loc15_;
         _loc16_.placeCursorAtTheEnd();
         this.api.electron.retroChatSetPromptText(_loc15_,true);
      }
      else
      {
         if(this.api.datacenter.Player.isAuthorized && !_loc6_)
         {
            if(this.api.kernel.AdminManager.executeHotKeyBatch(_loc14_))
            {
               return undefined;
            }
            _loc17_ = this.api.kernel.AdminManager.getAdminPopupMenu(_loc14_,false);
            if(oParams == undefined)
            {
               oParams = {};
            }
            oParams.bForceNonAdminPopup = true;
            _loc17_.addItem(_loc14_ + " >>",this,this.showPlayerPopupMenu,[oSpriteData,oParams],true);
            _loc17_.items.unshift(_loc17_.items.pop());
         }
         else
         {
            _loc17_ = this.getPlayerPopupMenu(_loc9_,oParams);
         }
         if(_loc17_.items.length > 0)
         {
            if(_loc8_ != undefined)
            {
               _loc17_.show(_loc8_.x,_loc8_.y,true);
            }
            else
            {
               _loc17_.show(_root._xmouse,_root._ymouse,true);
            }
         }
      }
   }
   ...
   {
      var _loc4_ = this.api.kernel.AdminManager.getAdminPopupMenu(sTeam,false);
   ...
   {
      var _loc4_ = this._aLastModified[nSlot];
      if(_loc4_ == undefined || _global.isNaN(_loc4_))
      {
         return 0;
      }
      return _loc4_;
   ...
   {
      var _loc5_ = oParams.bShowViewTtgCollection;
      var _loc6_ = oParams.bNoFriendsInvite;
      var _loc7_ = oParams.oPartyItem;
      var _loc8_ = oParams.bNoGuildInvite;
      var _loc9_ = oParams.bShowJoinFriend;
      if(spriteData != undefined && _loc5_ == undefined)
      {
         _loc5_ = spriteData.hasTtgCollection;
      }
      ...
      var _loc11_ = !(oParams.sPlayerID != undefined && oParams.sPlayerID.length > 0) ? spriteData.id : oParams.sPlayerID;
      var _loc12_ = oParams.sPlayerName == undefined ? spriteData.name : oParams.sPlayerName;
      var _loc13_ = this.api.ui.createPopupMenu();
      _loc13_.addStaticItem(_loc12_);
      var _loc14_ = this.api.kernel.ChatManager.isBlacklisted(_loc12_);
      if(_loc14_)
      {
         _loc13_.addStaticItem("(" + this.api.lang.getText("IGNORED_WORD") + ")");
      }
      if(_loc10_)
      {
         ...
         {
            if(spriteData != null && _loc11_ != this.api.datacenter.Player.ID)
            {
               _loc13_.addItem(this.api.lang.getText("KICK"),this.api.network.Game,this.api.network.Game.leave,[_loc11_]);
            }
         }
      }
      var _loc15_;
      ...
      var _loc23_;
      var _loc24_;
      if(_loc11_ == this.api.datacenter.Player.ID && _loc12_ == this.api.datacenter.Player.Name)
      {
         _loc13_.addItem(this.api.lang.getText("HIT_HIMSELF"),this.api.network.Chat,this.api.network.Chat.send,[this.api.lang.getText("SLAP_SENTENCE"),"*"]);
         if(!_loc10_ && this.api.datacenter.Player.canBeMerchant)
         {
            _loc13_.addItem(this.api.lang.getText("ORGANIZE_SHOP"),this.api.kernel.GameManager,this.api.kernel.GameManager.startExchange,[6]);
            _loc13_.addItem(this.api.lang.getText("MERCHANT_MODE"),this.api.kernel.GameManager,this.api.kernel.GameManager.offlineExchange);
         }
         if(this.api.datacenter.Player.data.isTomb)
         {
            _loc13_.addItem(this.api.lang.getText("FREE_MY_SOUL"),this.api.network.Game,this.api.network.Game.freeMySoul);
         }
         else if(!_loc10_)
         {
            _loc15_ = spriteData.animation == "static";
            _loc13_.addItem(this.api.lang.getText("CHANGE_DIRECTION"),this.api.ui,this.api.ui.loadUIComponent,["DirectionChooser","DirectionChooser",{allDirections:this.api.datacenter.Player.canMoveInAllDirections,target:this.api.datacenter.Player.data.mc}]);
         }
      }
      else
      {
         if(!this.api.kernel.ChatManager.isBlacklisted(_loc12_))
         {
            _loc13_.addItem(this.api.lang.getText("BLACKLIST_TEMPORARLY"),this.api.kernel.GameManager,this.api.kernel.GameManager.reportSentance,[_loc12_,_loc11_,undefined,spriteData]);
         }
         else
         {
            _loc13_.addItem(this.api.lang.getText("BLACKLIST_REMOVE"),this.api.kernel.ChatManager,this.api.kernel.ChatManager.removeToBlacklist,[_loc12_]);
         }
         if(!_loc10_ || _loc10_ && _loc12_ != undefined)
         {
            _loc13_.addItem(this.api.lang.getText("WHOIS"),this.api.network.Basics,this.api.network.Basics.whoIs,[_loc12_]);
            if(_loc11_ != undefined && (_loc12_ != undefined && _loc11_ != this.api.datacenter.Player.ID))
            {
               _loc16_ = spriteData != null && spriteData instanceof dofus.datacenter.OfflineCharacter;
               _loc13_.addItem(this.api.lang.getText("REPORT_PLAYER"),this.api.kernel.GameManager,this.api.kernel.GameManager.reportPlayer,[_loc11_,_loc12_,_loc16_]);
            }
            if(_loc6_ != true)
            {
               _loc13_.addItem(this.api.lang.getText("ADD_TO_FRIENDS"),this.api.network.Friends,this.api.network.Friends.addFriend,[_loc12_]);
            }
            if(_loc6_ != true)
            {
               _loc13_.addItem(this.api.lang.getText("ADD_TO_ENEMY"),this.api.network.Enemies,this.api.network.Enemies.addEnemy,[_loc12_]);
            }
            _loc13_.addItem(this.api.lang.getText("WISPER_MESSAGE"),this.api.kernel.GameManager,this.api.kernel.GameManager.askPrivateMessage,[_loc12_]);
            if(_loc7_ == undefined)
            {
               _loc13_.addItem(this.api.lang.getText("ADD_TO_PARTY"),this.api.network.Party,this.api.network.Party.invite,[_loc12_]);
            }
            if(_loc5_)
            {
               _loc13_.addItem(this.api.lang.getText("TTG_VIEW_COLLECTION"),this.api.network.Ttg,this.api.network.Ttg.sendShowCollection,[_loc12_]);
            }
            if(this.api.datacenter.Player.guildInfos != undefined)
            {
               if(_loc8_ != true)
               {
                  if(spriteData == null || (spriteData != null && spriteData.guildName == undefined || spriteData.guildName.length == 0))
                  {
                     ...
                     {
                        _loc13_.addItem(this.api.lang.getText("INVITE_IN_GUILD"),this.api.network.Guild,this.api.network.Guild.invite,[_loc12_]);
                     }
                  }
               }
            }
            if(_loc9_)
            {
               if(this.api.datacenter.Player.isAuthorized)
               {
                  _loc13_.addItem(this.api.lang.getText("JOIN_SMALL"),this.api.kernel.AdminManager,this.api.kernel.AdminManager.sendCommand,["join " + _loc12_]);
               }
               else if(this.api.datacenter.Map.superarea == 3)
               {
                  _loc13_.addItem(this.api.lang.getText("JOIN_SMALL"),this.api.network.Friends,this.api.network.Friends.joinFriend,[_loc12_]);
               }
            }
         }
         if(!_loc10_ && (spriteData != null && (spriteData.gfxID != ank.battlefield.datacenter.Sprite.ANGELS_OF_THE_WORLD_SPRITE_ID && !_loc6_)))
         {
            if(this.api.datacenter.Map.isMyHome)
            {
               _loc13_.addItem(this.api.lang.getText("KICKOFF"),this.api.network.Houses,this.api.network.Houses.kick,[_loc11_]);
            }
            if(this.api.datacenter.Player.canExchange && spriteData.canExchange)
            {
               _loc13_.addItem(this.api.lang.getText("EXCHANGE"),this.api.kernel.GameManager,this.api.kernel.GameManager.startExchange,[1,_loc11_]);
            }
            if(this.api.datacenter.Player.canChallenge && spriteData.canBeChallenge)
            {
               _loc13_.addItem(this.api.lang.getText("CHALLENGE"),this.api.network.GameActions,this.api.network.GameActions.challenge,[_loc11_],this.api.datacenter.Map.bCanChallenge);
            }
            if(this.api.datacenter.Player.canAssault && !spriteData.showIsPlayer)
            {
               _loc17_ = this.api.datacenter.Player.data.alignment.index;
               if(this.api.lang.getAlignmentCanAttack(_loc17_,spriteData.alignment.index))
               {
                  _loc18_ = this.api.datacenter.Map.bCanAttack;
                  _loc19_ = this.api.datacenter.Basics.pvpHuntedSpriteID != undefined && this.api.datacenter.Basics.pvpHuntedSpriteID == _loc11_;
                  if(!_loc18_ && (_loc19_ && this.api.datacenter.Map.bCanAttackHunt))
                  {
                     _loc18_ = true;
                  }
                  _loc13_.addItem(!_loc19_ ? this.api.lang.getText("ASSAULT") : this.api.lang.getText("ASSAULT") + " " + this.api.lang.getText("HUNTED"),this.api.kernel.GameManager,this.api.kernel.GameManager.askAttack,[[_loc11_]],_loc18_);
               }
            }
            if(this.api.datacenter.Player.canAttack && (spriteData.canBeAttack && !spriteData.showIsPlayer))
            {
               _loc13_.addItem(this.api.lang.getText("ATTACK"),this.api.network.GameActions,this.api.network.GameActions.mutantAttack,[_loc11_]);
            }
            _loc20_ = spriteData.multiCraftSkillsID;
            if(_loc20_ != undefined && _loc20_.length > 0)
            {
               _loc21_ = 0;
               while(_loc21_ < _loc20_.length)
               {
                  _loc22_ = Number(_loc20_[_loc21_]);
                  _loc13_.addItem(this.api.lang.getText("ASK_TO") + " " + this.api.lang.getSkillText(_loc22_).d,this.api.network.Exchange,this.api.network.Exchange.request,[13,_loc11_,_loc22_]);
                  _loc21_ += 1;
               }
            }
            else
            {
               _loc20_ = this.api.datacenter.Player.data.multiCraftSkillsID;
               if(_loc20_ != undefined && _loc20_.length > 0)
               {
                  _loc23_ = 0;
                  while(_loc23_ < _loc20_.length)
                  {
                     _loc24_ = Number(_loc20_[_loc23_]);
                     _loc13_.addItem(this.api.lang.getText("INVITE_TO") + " " + this.api.lang.getSkillText(_loc24_).d,this.api.network.Exchange,this.api.network.Exchange.request,[12,_loc11_,_loc24_]);
                     _loc23_ += 1;
                  }
               }
            }
      ...
      if(_loc7_ != undefined)
      {
         _loc7_.addPartyMenuItems(_loc13_);
      }
      return _loc13_;
   }
   function inactivityCheck()
   {
      ...
      var _loc3_ = this.api.lang.getConfigText("INACTIVITY_DISPLAY_COUNT");
      if(_global.isNaN(_loc3_) || _loc3_ == undefined)
      {
         _loc3_ = 5;
      }
      if(this.api.datacenter.Basics.inactivity_signaled > _loc3_)
      {
         return undefined;
      }
      var _loc4_ = this.api.lang.getConfigText("INACTIVITY_TIMING");
      if(_global.isNaN(_loc4_) || (_loc4_ == undefined || _loc4_ < 1000))
      {
         _loc4_ = 11000;
      }
      if(this._nLastActivity + _loc4_ < getTimer())
      {
