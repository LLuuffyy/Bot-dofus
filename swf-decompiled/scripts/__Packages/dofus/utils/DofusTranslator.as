class dofus.utils.DofusTranslator extends dofus.utils.ApiElement
{
   ...
   {
      var _loc4_ = this.getValueFromSOXtra("MA").m[nMapID].c;
   ...
   {
      var _loc4_ = this.getValueFromSOXtra("MA").m[nMapID].t;
      if(_loc4_ == undefined || _global.isNaN(_loc4_))
      {
   ...
   {
      var _loc3_ = this.getValueFromSOXtra("IS")[nKey];
      var _loc4_;
      if(_loc3_ == undefined && this.getDataBank() == dofus.utils.DofusTranslator.TEMPORIS_DATA_BANK)
      {
         _loc4_ = this.getValueFromSOXtra("IS",dofus.utils.DofusTranslator.STANDARD_DATA_BANK);
         if(_loc4_ != undefined)
         {
            _loc3_ = _loc4_[nKey];
         }
   ...
   {
      var _loc3_ = this.getValueFromSOXtra("ISTA")[nKey];
      var _loc4_;
      if(_loc3_ == undefined && this.getDataBank() == dofus.utils.DofusTranslator.TEMPORIS_DATA_BANK)
      {
         _loc4_ = this.getValueFromSOXtra("ISTA",dofus.utils.DofusTranslator.STANDARD_DATA_BANK);
         if(_loc4_ != undefined)
         {
            _loc3_ = _loc4_[nKey];
         }
   ...
   {
      var _loc3_ = this.getValueFromSOXtra("I");
      var _loc4_ = _loc3_ != undefined ? _loc3_.u[nKey] : undefined;
      var _loc5_;
      if(_loc4_ == undefined && this.getDataBank() == dofus.utils.DofusTranslator.TEMPORIS_DATA_BANK)
      {
         _loc5_ = this.getValueFromSOXtra("I",dofus.utils.DofusTranslator.STANDARD_DATA_BANK);
         if(_loc5_ != undefined && _loc5_.u != undefined)
         {
            _loc4_ = _loc5_.u[nKey];
         }
      }
      return _loc4_;
   }
   ...
   {
      var _loc3_ = this.getValueFromSOXtra("I");
      var _loc4_ = _loc3_ != undefined ? _loc3_.t[nTypeID] : undefined;
      var _loc5_;
      if(_loc4_ == undefined && this.getDataBank() == dofus.utils.DofusTranslator.TEMPORIS_DATA_BANK)
      {
         _loc5_ = this.getValueFromSOXtra("I",dofus.utils.DofusTranslator.STANDARD_DATA_BANK);
         if(_loc5_ != undefined && _loc5_.t != undefined)
         {
            _loc4_ = _loc5_.t[nTypeID];
         }
      }
      return _loc4_;
   }
   ...
   {
      var _loc3_ = this.getValueFromSOXtra("I");
      var _loc4_ = _loc3_ != undefined ? _loc3_.st[nSuperTypeID] : undefined;
      var _loc5_;
      if(_loc4_ == undefined && this.getDataBank() == dofus.utils.DofusTranslator.TEMPORIS_DATA_BANK)
      {
         _loc5_ = this.getValueFromSOXtra("I",dofus.utils.DofusTranslator.STANDARD_DATA_BANK);
         if(_loc5_ != undefined && _loc5_.st != undefined)
         {
            _loc4_ = _loc5_.st[nSuperTypeID];
         }
      }
      return _loc4_;
   }
   ...
   {
      var _loc3_ = this.getValueFromSOXtra("E")[nEffectID];
      var _loc4_;
      if(_loc3_ == undefined && this.getDataBank() == dofus.utils.DofusTranslator.TEMPORIS_DATA_BANK)
      {
         _loc4_ = this.getValueFromSOXtra("E",dofus.utils.DofusTranslator.STANDARD_DATA_BANK);
         if(_loc4_ != undefined)
         {
            _loc3_ = _loc4_[nEffectID];
         }
      }
      return _loc3_;
   }
   ...
   function getEmoteID(sEmoteShortcut)
   {
      ...
      {
         if(_loc3_[_loc4_].s == sEmoteShortcut)
         {
   ...
   function getLangFileSize(nDataBank, sLangFile)
   {
      ...
      {
         _loc5_ = dofus.Constants.GLOBAL_SO_LANG_NAME + "_" + nDataBank;
      }
      else
      {
         if(sLangFile.toUpperCase() == "TOTAL")
         {
            _loc6_ = this.getLangFileSize(nDataBank,"lang");
            _loc7_ = _global.API.lang.getConfigText("XTRA_FILE");
            _loc8_ = 0;
            while(_loc8_ < _loc7_.length)
            {
               _loc6_ += this.getLangFileSize(_loc7_[_loc8_]);
               _loc8_ += 1;
            }
            return _loc6_;
         }
         _loc5_ = dofus.Constants.GLOBAL_SO_XTRA_NAME + "_" + nDataBank;
      }
      var _loc9_ = _global[_loc5_].data.WEIGHTS[sLangFile.toUpperCase()];
   ...
   function fetchString(s)
   {
      ...
      if(this.fetchIn == undefined || (this.fetchOut == undefined || this._nLastServerID != this.api.datacenter.Basics.aks_current_server.id))
      {
         ...
         {
            _loc6_ = this.getServerSpecificText(Number(_loc5_),this._nLastServerID);
            if(_loc6_ == undefined)
            {
               _loc6_ = _loc4_[_loc5_].d;
            }
            this.fetchIn.push("`SRVT:" + _loc4_[_loc5_].l + "`");
            this.fetchOut.push(_loc6_);
         }
      }
   ...
   {
      var _loc4_ = this.getDataBank();
      var _loc5_ = dofus.Constants.GLOBAL_SO_LANG_NAME + "_" + _loc4_;
      return _global[_loc5_].data[sKey];
   }
   function getValueFromSOXtra(sKey, nForcedDataBank)
   {
      ...
      {
         _loc5_ = nForcedDataBank;
      }
      else
      {
         _loc5_ = this.getDataBank();
      }
      var _loc6_ = dofus.Constants.XTRA_SHAREDOBJECT_NAME + "_" + _loc5_ + "_" + sKey;
      var _loc7_ = _global[_loc6_];
      if(_loc7_ == undefined)
      {
         _global[_loc6_] = ank.utils.SharedObjectFix.getLocal(_loc6_);
         _loc7_ = _global[_loc6_];
      }
      var _loc8_ = _loc7_.data[sKey];
      var _loc9_;
      var _loc10_;
      if(_loc8_ instanceof Array)
      {
         _loc9_ = this._aSOXtraCache[_loc5_];
         if(_loc9_ == undefined)
         {
            _loc9_ = [];
            this._aSOXtraCache[_loc5_] = _loc9_;
         }
         _loc10_ = _loc9_[sKey];
         if(_loc10_ == undefined)
         {
            _loc10_ = _loc8_.slice();
            _loc9_[sKey] = _loc10_;
         }
         return _loc10_;
      }
