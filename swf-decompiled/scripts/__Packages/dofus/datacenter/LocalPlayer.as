class dofus.datacenter.LocalPlayer extends dofus.utils.ApiElement
{
   ...
   {
      if(this.api.datacenter.Game.isControllingInvocation && this.api.datacenter.Game.currentPlayerID == this.api.datacenter.Game.controlledInvocationID)
      {
         return true;
      }
   ...
   function initSpellsDictionnary()
   {
      ...
      for(var _loc7_ in _loc2_)
      {
         ...
         while(_loc4_ <= 6)
         {
            ...
            {
               _loc6_ = _loc5_[20];
               this.spellIDByLevelID[_loc6_] = _loc7_;
            }
            _loc4_ += 1;
         }
      }
   ...
   function getBoostCostAndCountForCharacteristic(nCharacID)
   {
      ...
      var _loc11_ = _loc9_ == _loc3_.length;
      var _loc12_;
      var _loc13_;
      if(_loc11_)
      {
      ...
      else
      {
         ...
         while(_loc12_ < _loc10_ && _loc13_ >= _loc4_)
         {
            _loc12_ += _loc5_;
            _loc13_ -= _loc4_;
            _loc7_ += 1;
