class dofus.aks.DataProcessor extends dofus.aks.Handler
{
   ...
   {
      if(sData.substr(0,5) == "CRYPT")
      {
         this.aks.handleCryptoMessage(sData);
         return undefined;
      }
   ...
   function postProcess(sType, sAction, bError, sData)
   {
      ...
      switch(sType)
      {
         case "H":
            ...
            {
               case "T":
                  _loc7_ = sData.substr(2);
                  this.aks.onTelemetry(_loc7_,_loc7_ == "yolo");
                  return undefined;
               case "C":
         ...
         case "A":
            switch(sAction)
            {
               case "E":
                  ...
                  _loc10_ = sData.charAt(3) != undefined && sData.charAt(3) == "f";
                  if(this.api.ui.getUIComponent("EditPlayer") == undefined)
                  {
                     this.api.ui.loadUIComponent("EditPlayer","EditPlayer",{editName:_loc8_,editColors:_loc9_,force:_loc10_});
                  }
                  break;
               case "c":
               ...
               case "-":
                  ...
                  {
                     case "A":
                        this.api.ui.loadUIAutoHideComponent("Ornatitle","Ornatitle");
                        break;
                     case "a":
                        if(this.api.ui.getUIComponent("Ornatitle") != undefined)
                        {
                           this.api.ui.getUIComponent("Ornatitle").datos(sData.substr(3));
                        }
                        break;
                     default:
               ...
               case "m":
                  ...
                  {
                     _loc11_ = _global.parseInt(sData.charAt(2),10);
                     if(_global.isNaN(_loc11_))
                     {
                        _loc11_ = 3;
                     }
                     fscommand("GoToCongratulation",_loc11_);
                  }
               default:
                  return undefined;
            }
         ...
         case "O":
            ...
            switch(sAction)
            {
               ...
               case "r":
                  ...
                  return undefined;
               case "L":
                  this.aks.Items.onPlayerLock(sData.substr(2));
                  return undefined;
               default:
                  this.defaultProcessAction(sType,sAction,bError,sData);
                  return undefined;
               ...
               case "I":
                  switch(sData.charAt(2))
                  {
                     ...
                     case "h":
                        ...
                        return undefined;
                     case "+":
                        this.aks.Game.extendIn.onInvocationControl(sData.substr(2));
                        return undefined;
                     case "-":
                        this.aks.Game.extendIn.onInvocationControl(sData.substr(2));
                        return undefined;
         ...
         case "I":
            switch(sAction)
            {
               ...
               case "L":
                  ...
                  break;
               case "P":
                  this.aks.Infos.onAutopilotPath(sData.substr(2));
                  return undefined;
               default:
                  this.defaultProcessAction(sType,sAction,bError,sData);
                  return undefined;
         ...
         case "F":
            switch(sAction)
            {
               ...
               case "O":
                  ...
                  return undefined;
               case "M":
                  this.aks.Exchange.onFmQuickAction(sData.substr(2));
                  return undefined;
               default:
                  this.defaultProcessAction(sType,sAction,bError,sData);
                  return undefined;
         ...
         case "J":
            switch(sAction)
            {
               ...
               case "O":
                  ...
                  return undefined;
               case "K":
                  this.aks.Job.onFmCraftUpdate(sData.substr(2));
                  return undefined;
               default:
                  this.defaultProcessAction(sType,sAction,bError,sData);
                  return undefined;
