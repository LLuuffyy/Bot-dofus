class dofus.aks.Basics extends dofus.aks.Handler
{
   ...
   function travelCommand(nX, nY)
   {
      this.aks.send("Bt" + nX + "," + nY,false);
   }
   ...
   function onAuthorizedCommand(bSuccess, sExtraData)
   {
      ...
      if(bSuccess)
      {
         _loc5_ = dofus.graphics.gapi.ui.Debug(this.api.ui.getUIComponent("Debug"));
         if(_loc5_ == undefined && (dofus.graphics.gapi.ui.Debug.FILE_OUTPUT_STATE < 2 && !(this.api.electron.isShowingWidescreenPanel && this.api.electron.getWidescreenPanelId() == dofus.Electron.WIDESCREEN_PANEL_CONSOLE)))
         {
            this.api.ui.loadUIComponent("Debug","Debug",undefined,{bStayIfPresent:true,bAlwaysOnTop:true});
         }
         _loc6_ = dofus.graphics.gapi.ui.Debug.FILE_OUTPUT_STATE;
         ...
         if(_loc8_ == 4)
         {
            ...
            _loc7_.splice(0,2);
            _loc8_ = Number(_loc7_[0].substring(3));
         }
         _loc10_ = Number(_loc7_[1]);
         _loc11_ = _loc7_[2];
         _loc7_.splice(0,3);
         _loc12_ = _loc7_.join("|");
         if(_loc8_ == undefined || (_loc10_ == undefined || (_loc11_ == undefined || _loc12_ == undefined)))
         {
            this.api.kernel.showMessage(undefined,"Erreur de protocole","DEBUG_ERROR");
            _loc13_ = 0;
            while(_loc13_ < _loc7_.length)
            {
               this.api.kernel.showMessage(undefined,_loc13_ + " : " + _loc7_[_loc13_],"DEBUG_ERROR");
               _loc13_ += 1;
            }
            return undefined;
         }
         ...
         _loc12_ = this.api.kernel.DebugManager.getFormattedMessage(_loc12_,"");
         if(this.api.electron.enabled)
         {
            if(_loc11_.length > 0 && _loc10_ > 0)
            {
               _loc15_ = this.api.datacenter.Temporary.Report;
               if(_loc15_ != undefined)
               {
                  _loc16_ = this.api.kernel.AdminManager.pendingModReportAppendCommands;
                  if(_loc16_ != undefined)
                  {
                     _loc17_ = _loc16_.length - 1;
                     while(_loc17_ >= 0)
                     {
                        _loc18_ = _loc16_[_loc17_];
                        if(_loc18_.command == _loc11_)
                        {
                           _loc19_ = false;
                           _loc20_ = _loc18_.types;
                           if(_loc20_.length > 0)
                           {
                              _loc21_ = this.api.electron.getXmlEscapedString(this.api.electron.getHtmlStrippedString(_loc12_));
                              _loc22_ = 0;
                              while(_loc22_ < _loc20_.length)
                              {
                                 switch(_loc20_[_loc22_])
                                 {
                                    case 1:
                                       _loc19_ = true;
                                       if(_loc15_.description == undefined)
                                       {
                                          _loc15_.description = _loc21_;
                                          break;
                                       }
                                       _loc15_.description += "\n" + _loc21_;
                                       break;
                                    case 2:
                                       _loc19_ = true;
                                       if(_loc15_.complementary == undefined)
                                       {
                                          _loc15_.complementary = _loc21_;
                                          break;
                                       }
                                       _loc15_.complementary += "\n" + _loc21_;
                                 }
                                 _loc22_ += 1;
                              }
                              if(_loc19_)
                              {
                                 _loc16_.splice(_loc17_,1);
                                 _loc23_ = dofus.graphics.gapi.ui.MakeReport(this.api.ui.getUIComponent("MakeReport"));
                                 if(_loc23_ != undefined)
                                 {
                                    _loc23_.update(false);
                                 }
                                 return undefined;
                              }
                           }
            ...
            if(_loc9_ != undefined)
            {
               _loc24_ = this.onAutorizedCommandBuildGridObject(_loc9_);
            }
            if(!_global.isNaN(_loc10_) && _loc10_ > 0)
            {
               if(_loc10_ == 1)
               {
                  _loc26_ = this.api.electron.getXmlEscapedString(this.api.electron.getHtmlStrippedString(_loc12_));
                  _loc25_ = "<br/>" + this.getAppendReportDescriptionLink(_loc26_) + " " + this.getAppendReportComplementaryLink(_loc26_);
                  _loc12_ += _loc25_;
               }
               else if(_loc10_ == 2)
               {
                  _loc27_ = this.api.electron.getXmlEscapedString(this.api.electron.getHtmlStrippedString(_loc12_));
                  _loc25_ = "<br/>" + this.getAppendReportPenalLink(_loc27_);
                  _loc12_ += _loc25_;
               }
               if(_loc25_ != undefined && _loc24_ != undefined)
               {
                  if(_loc24_.afterGridText != undefined)
                  {
                     _loc24_.afterGridText += _loc25_;
                  }
                  else
                  {
                     _loc24_.afterGridText = _loc25_;
            ...
            _loc28_ = new ank.utils.ExtendedString(_loc12_).externalInterfaceEscape();
            this.api.electron.consolePrint(_loc28_,_loc14_,_loc24_,true);
            if(_loc6_ != 0)
            {
               this.api.electron.consoleLog(_loc14_,_loc28_,true);
               if(_loc6_ == 2)
               {
                  return undefined;
               }
         ...
         {
            this.api.kernel.showMessage(undefined,_loc12_,_loc14_);
         }
         if(dofus.Constants.SAVING_THE_WORLD)
         {
            if(_loc12_.indexOf("BotKick inactif") == 0)
            {
   ...
   function onAuthorizedLine(sExtraData)
   {
      ...
      var _loc7_ = _loc4_[2];
      var _loc8_ = this.api.datacenter.Basics.aks_a_logs.split("<br/>");
      var _loc9_ = "<font color=\"#FFFFFF\">" + _loc7_ + "</font>";
      switch(_loc6_)
      {
         case 1:
            _loc9_ = "<font color=\"#FF0000\">" + _loc7_ + "</font>";
            break;
         case 2:
            _loc9_ = "<font color=\"#00FF00\">" + _loc7_ + "</font>";
      }
      if(!_global.isNaN(_loc5_) && _loc5_ < _loc8_.length)
      {
         _loc8_[_loc8_.length - _loc5_] = _loc9_;
         this.api.datacenter.Basics.aks_a_logs = _loc8_.join("<br/>");
   ...
   function onBrightCell(sExtraData)
   {
      ...
      {
         _loc6_ = _loc4_[0].substr(1).split(".");
         this.api.gfx.unSelect(false,_loc6_,"brightedPosition");
      }
      else
      {
         _loc7_ = _loc4_[0].split(".");
         _loc8_ = _global.parseInt(_loc4_[1],16);
         this.api.gfx.select(_loc7_,_loc8_,"brightedPosition");
      }
   }
