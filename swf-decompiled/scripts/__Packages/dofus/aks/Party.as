class dofus.aks.Party extends dofus.aks.Handler
{
   ...
   function promoteLeader(sSpriteID)
   {
      this.aks.send("PP" + sSpriteID);
   }
   ...
   {
      var _loc3_;
      if((_loc3_ = oEvent.target._name) === "AskCancelParty")
      {
         this.refuseInvitation();
      }
   }
   ...
   {
      var _loc3_;
      if((_loc3_ = oEvent.target._name) === "AskYesNoIgnoreParty")
      {
