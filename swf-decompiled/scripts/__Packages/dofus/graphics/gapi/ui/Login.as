class dofus.graphics.gapi.ui.Login extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function refreshAutoLoginUi()
   {
      ...
      {
         _loc4_ = dofus.ZaapConnect.getInstance();
   ...
   function createChildren()
   {
      ...
      {
         _loc4_ = this.api.lang.getConfigText("ALERTY_LINK");
         if(_loc4_ != "")
         {
   ...
   function loadFlags()
   {
      ...
      while(_loc4_ < _loc3_.length)
      {
         ...
         _loc6_ = this.attachMovie("UI_LoginLanguage" + _loc5_.toUpperCase(),"_mcFlag" + _loc5_.toUpperCase(),this.getNextHighestDepth());
         if(_loc8_ == undefined)
         {
            _loc7_ = (this._mcBgFlags._width - _loc3_.length * _loc6_._width) / (_loc3_.length + 1);
            _loc8_ = this._mcBgFlags._x + _loc7_;
            _loc9_ = this._mcBgFlags._y + (this._mcBgFlags._height - _loc6_._height) / 2;
         }
         _loc6_._x = _loc8_;
         _loc6_._y = _loc9_;
         ...
         _loc10_ = this.attachMovie("UI_Login_flagsMask","_mcMask" + _loc5_.toUpperCase(),this.getNextHighestDepth());
         _loc10_._x = _loc8_;
         _loc10_._y = _loc9_;
   ...
   function fillCommunityID()
   {
      ...
      {
         _loc6_ = this.api.lang.getConfigText("DEFAULT_COMMUNITY");
         _loc7_ = _loc6_.split(",");
   ...
   function onLogin(sLogin, sPassword, bZaapConnect)
   {
      ...
      if(!bZaapConnect)
      {
         if(dofus.Constants.DEBUG)
         {
            ...
            _loc6_.data.loginInfos = {account:sLogin,password:sPassword};
            _loc6_.close();
         }
      ...
      {
         _loc7_ = this.api.lang.getConfigText("SERVER_NAME");
         _loc8_ = new ank.utils.ExtendedArray();
         _loc9_ = Math.floor(Math.random() * _loc7_.length);
         _loc10_ = 0;
         while(_loc10_ < _loc7_.length)
         {
            _loc8_.push(_loc7_[(_loc9_ + _loc10_) % _loc7_.length]);
            _loc10_ += 1;
         }
         this.api.datacenter.Basics.aks_connection_server = _loc8_;
         this._sServerIP = String(_loc8_.shift());
      }
      ...
      {
         _loc11_ = this.api.lang.getText("NO_SERVER_ADDRESS");
         this.api.kernel.showMessage(this.api.lang.getText("CONNECTION"),_loc11_ != undefined ? _loc11_ : "Erreur interne\nContacte l\'équipe Dofus","ERROR_BOX",{name:"OnLogin"});
      }
      else
      {
      ...
      switch(oEvent.target._name)
      {
         ...
         case "_mcSubscribe":
            ...
            if(this.api.lang.getConfigText("REGISTER_INGAME"))
            {
               ...
               _loc4_ = this.gapi.loadUIComponent("Register","Register");
               _loc5_ = dofus.graphics.gapi.ui.Register(_loc4_);
         ...
         case "_btnServersState":
            _loc7_ = SharedObject.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME);
         ...
         default:
            ...
            {
               _loc9_ = oEvent.target.params.url;
            ...
            _loc8_ = String(oEvent.target._name).substr(7,2).toLowerCase();
            if(this.api.config.isStreaming)
            {
   ...
   function onGifts(oLoadVars, bSuccess)
   {
      ...
      {
         _loc6_ = this.createEmptyMovieClip("_mcMaskGift",this.getNextHighestDepth());
         with(_loc6_)
         {
            beginFill(0,100);
            moveTo(43,400);
         ...
         while(_loc7_ <= _loc5_)
         {
            _loc8_ = ank.gapi.controls.Button(this._mcGifts.attachMovie("Button","btn" + _loc7_,_loc7_,{_x:(_loc7_ - 1) * 131,_width:110,_height:92,backgroundDown:"ButtonTransparentUp",backgroundUp:"ButtonTransparentUp",styleName:"none"}));
            ...
            _loc9_ = ank.gapi.controls.Loader(this._mcGifts.attachMovie("GAPILoader","ldr" + _loc7_,_loc7_ + 100,{_x:(_loc7_ - 1) * 131,_width:110,_height:92}));
