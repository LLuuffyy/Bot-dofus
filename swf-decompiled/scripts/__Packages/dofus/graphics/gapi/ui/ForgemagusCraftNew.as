class dofus.graphics.gapi.ui.ForgemagusCraftNew extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   var _aGarbageMemory;
   var _bIsLooping;
   var _bMakeAll;
   ...
   function init()
   {
      super.init(false,dofus.graphics.gapi.ui.ForgemagusCraftNew.CLASS_NAME);
   ...
   function updateDataVisually()
   {
      ...
      var _loc2_ = this.api.datacenter.Basics[dofus.graphics.gapi.ui.ForgemagusCraftNew.CLASS_NAME + "_subfilter_" + this._btnSelectedFilterButton._name];
      ...
      var _loc7_;
      var _loc8_;
      for(var _loc9_ in this._eaDataProvider)
      {
         _loc6_ = this._eaDataProvider[_loc9_];
         _loc7_ = _loc6_.position;
         if(!_loc6_.isPlayerLocked)
         {
         }
   ...
   function updateLocalDataVisually()
   {
      ...
      while(_loc6_ < this._eaLocalDataProvider.length)
      {
         _loc7_ = false;
         _loc8_ = 0;
         while(_loc8_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE.length)
         {
            if(dofus.graphics.gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE[_loc8_] == this._eaLocalDataProvider[_loc6_].unicID)
            {
               _loc5_ = true;
         ...
         _loc9_ = 0;
         while(_loc9_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length)
         {
            if(dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc9_] == this._eaLocalDataProvider[_loc6_].type)
            {
               _loc4_ = true;
   ...
   function validateDrop(sTargetGrid, oItem, nValue)
   {
      ...
      if(oItem != undefined)
      {
         _loc6_ = this._eaDataProvider.findFirstItem("ID",oItem.ID);
         _loc7_ = this._eaDataProvider.findFirstItem("ID",Number(oItem.ID));
      }
      ...
      switch(sTargetGrid)
      {
         ...
         case "_ctrSignature":
            ...
            {
               case "_ctrItem":
                  if(this._nForgemagusItemType != oItem.type || !oItem.enhanceable || oItem.hasFragment)
                  {
                     return undefined;
                  }
                  _loc10_ = 0;
                  while(_loc10_ < this._eaLocalDataProvider.length)
                  {
                     _loc11_ = false;
                     _loc12_ = 0;
                     while(_loc12_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE.length)
                     {
                        if(dofus.graphics.gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE[_loc12_] == this._eaLocalDataProvider[_loc10_].unicID)
                        {
                           _loc11_ = true;
                        }
                        _loc12_ += 1;
                     ...
                     _loc13_ = 0;
                     while(_loc13_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length)
                     {
                        if(dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc13_] == this._eaLocalDataProvider[_loc10_].type)
                        {
                           _loc11_ = true;
                        }
                        _loc13_ += 1;
                     ...
                     if(!_loc11_)
                     {
                        this.api.network.Exchange.movementItem(false,this._eaLocalDataProvider[_loc10_],this._eaLocalDataProvider[_loc10_].Quantity);
                     }
                     _loc10_ += 1;
                  }
                  _loc8_ = true;
               ...
               case "_ctrRune":
                  ...
                  {
                     _loc15_ = 0;
                     while(_loc15_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length)
                     {
                        if(dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc15_] == this._eaLocalDataProvider[_loc14_].type && this._eaLocalDataProvider[_loc14_].unicID != oItem.unicID)
                        {
               ...
               case "_ctrSignature":
                  _loc16_ = 0;
                  while(_loc16_ < this._eaLocalDataProvider.length)
                  {
                     _loc17_ = 0;
                     while(_loc17_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE.length)
                     {
                        if(dofus.graphics.gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE[_loc17_] == this._eaLocalDataProvider[_loc16_].unicID)
                        {
                           this.api.network.Exchange.movementItem(false,this._eaLocalDataProvider[_loc16_],this._eaLocalDataProvider[_loc16_].Quantity);
                        }
                        _loc17_ += 1;
                     }
                     _loc16_ += 1;
            ...
            if(!_loc9_)
            {
               ...
               if(sTargetGrid == "_ctrRune")
               {
                  this.api.network.Exchange.resetLastMovedItem();
               }
   ...
   function click(oEvent)
   {
      switch(oEvent.target)
      {
         case this._btnEmptyLogs:
            this.historyList = new ank.utils.ExtendedArray();
   ...
   function drop(oEvent)
   {
      ...
      switch(oEvent.target)
      {
         case this._ctrItem:
            _loc4_ = _loc5_ = true;
            _loc6_ = 0;
            while(_loc6_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length)
            {
               if(dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc6_] == _loc3_.type)
               {
                  _loc4_ = false;
               }
               _loc6_ += 1;
            ...
            _loc7_ = 0;
            while(_loc7_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE.length)
            {
               if(dofus.graphics.gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE[_loc7_] == _loc3_.unicID)
               {
                  _loc4_ = false;
               }
               _loc7_ += 1;
         ...
         case this._ctrRune:
            _loc8_ = 0;
            while(_loc8_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length)
            {
               if(dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc8_] == _loc3_.type)
               {
                  _loc4_ = true;
               }
               _loc8_ += 1;
         ...
         case this._ctrSignature:
            _loc9_ = 0;
            while(_loc9_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE.length)
            {
               if(dofus.graphics.gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE[_loc9_] == _loc3_.unicID)
               {
                  _loc4_ = true;
               }
               _loc9_ += 1;
      ...
      var _loc10_;
      var _loc11_ = Key.isDown(Key.SHIFT);
      var _loc12_ = oEvent.target == this._ctrRune;
      if(_loc12_)
      {
         this.validateDrop(oEvent.target._name,_loc3_,_loc3_.Quantity);
         if(_loc11_ && this._ctrItem.contentData != undefined)
         {
            this.addToQueue({object:this,method:this.setReady});
         }
      }
      else if(!_loc5_ && _loc3_.Quantity > 1)
      {
         _loc10_ = this.gapi.loadUIComponent("PopupQuantity","PopupQuantity",{value:_loc3_.Quantity,max:_loc3_.Quantity,params:{targetType:"item",oItem:_loc3_,targetGrid:oEvent.target._name}});
   ...
   function dblClickItem(oEvent)
   {
      ...
      switch(_loc5_)
      {
         case "_cgGrid":
            ...
            {
               _loc7_ = 0;
               while(_loc7_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE.length && _loc6_ == undefined)
               {
                  if(dofus.graphics.gapi.ui.ForgemagusCraftNew.ITEMS_ALLOWED_AS_SIGNATURE[_loc7_] == _loc3_.unicID)
                  {
               ...
               _loc8_ = 0;
               while(_loc8_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length && _loc6_ == undefined)
               {
                  if(dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc8_] == _loc3_.type)
                  {
                     _loc6_ = "_ctrRune";
   ...
   function selectItem(oEvent)
   {
      ...
      var _loc3_ = oEvent.target.contentData;
      var _loc4_ = oEvent.owner != undefined ? oEvent.owner._name : oEvent.target._parent._parent._name;
      if(_loc4_ == "_cgGrid" && this.isRuneItem(_loc3_))
      {
         if(Key.isDown(Key.CONTROL))
         {
            this.bulkMoveRunes(_loc3_);
            return undefined;
         }
         this.fuseRuneDirectly(_loc3_);
         return undefined;
      }
      this.hideItemViewer(false);
      this._itvItemViewer.itemData = oEvent.target.contentData;
   }
   function isRuneItem(oItem)
   {
      if(oItem == undefined || oItem.type == undefined)
      {
         return false;
      }
      var _loc2_ = 0;
      while(_loc2_ < dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT.length)
      {
         if(dofus.graphics.gapi.ui.ForgemagusCraftNew.TYPES_ALLOWED_AS_COMPONENT[_loc2_] == oItem.type)
         {
            return true;
         }
         _loc2_ += 1;
   ...
   function fuseRuneDirectly(oItem)
   {
      if(oItem == undefined)
      {
         return undefined;
      ...
      if(this._ctrItem.contentData != undefined)
      {
         this.api.kernel.showMessage(undefined,"Fusion en cours...","INFO_CHAT");
         _global.API.network.send("FMF" + oItem.ID + "|1");
      }
      else
      {
         this.validateDrop("_ctrRune",oItem,oItem.Quantity);
      }
   }
   function bulkMoveRunes(oItem)
   {
      if(oItem == undefined || oItem.unicID == undefined)
      {
         return undefined;
      }
      this.api.kernel.showMessage(undefined,"Transfert des runes...","INFO_CHAT");
      _global.API.network.send("FMB" + oItem.unicID + "|0");
   }
   ...
   function itemSelected(oEvent)
   {
      ...
      if((_loc3_ = oEvent.target._name) === "_cbTypes")
      {
         ...
         this.api.datacenter.Basics[dofus.graphics.gapi.ui.ForgemagusCraftNew.CLASS_NAME + "_subfilter_" + this._btnSelectedFilterButton._name] = this._nSelectedTypeID;
         this.updateData();
      }
   }
}
